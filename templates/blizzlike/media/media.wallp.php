<br>
<?php builddiv_start(1, $lang['wallp']) ?>
<?php
...
<?php if($user['id']>=1){ ?>
<tr><td ><img src="<?php echo $currtmp; ?>/images/edit-button.gif"><a href="././index.php?n=media&sub=addgalwallp"><?php echo $lang['Addimage'];?></a></td>
...
<td background="<?php echo $currtmp; ?>/images/gallery/_t.gif"><img src="/i/_.gif" height="1" width="1"></td>
<td><img src="<?php echo $currtmp; ?>/images/gallery/rt.png" class="png" style="width: 11px; height: 9px;" border="0" height="9" width="11"></td>
</tr>
<tr>
<td background="<?php echo $currtmp; ?>/images/gallery/_l.gif"><img src="/i/_.gif" height="1" width="1"></td>
<td>
<a style="cursor: pointer;" onclick="javascript:void(window.open('./images/wallpapers/<?php echo $tablerows['img'];?>'))" target="_blank"><img style="width: 235px; height: 175px;" alt="<?php echo  $tablerows['comment'];?>"
src="modules/ssotd/show_picture.php?filename=<?php echo  $tablerows['img'];?>&gallery=wallp&width=235&height=175" border="0"></a>
</td>
<td background="<?php echo $currtmp; ?>/images/gallery/_r.gif"><img src="/i/_.gif" height="1" width="1"></td>
</tr>
<tr>
<td><img src="<?php echo $currtmp; ?>/images/gallery/lb.png" class="png" style="width: 9px; height: 12px;" border="0" height="12" width="9"></td>
<td background="<?php echo $currtmp; ?>/images/gallery/_b.gif"><img src="/i/_.gif" height="1" width="1"></td>
...
<?php //the comment does not allow to be inputted, so don't show it here
/*
