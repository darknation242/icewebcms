            ...
            <div class="news-top">
              <ul>
                ...
                <li class="news-entry">
                  ...
                  <span class="user">Posted by: <b><?php echo $topic['posted_by'];?></b>|</span>&nbsp;<span class="posted-date"><?php echo date('d-m-Y',$topic['post_time']);?></span>
                </li>
                <li class="news-entry-date">
                  <span><strong><?php echo date('d-m-Y',$topic['post_time']);?> </strong></span>
                </li>
                <li class="news-toggle">
                  <a href="javascript:toggleEntry('<?php echo $topic['id'];?>','<?php echo$hl;?>')"><img src="<?php echo $currtmp; ?>/images/pixel001.gif" alt=""/></a>
                </li>
              </ul>
            </div>
          </div>
